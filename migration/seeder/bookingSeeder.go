...
func BookingSeed(db *gorm.DB) {
	...
	db.Create(&model.Booking{
		...
		Longitude:  100.551289,
		Location:   `Silpakorn University`,
		DateTime:   time.Now().AddDate(1, 5, 0).Add(40 * time.Hour).Add(45 * time.Minute),
		Duration:   `1:30:00`,
		Price:      12000,
		Instrument: false,
	})
	...
	db.Create(&model.Booking{
		...
		Longitude:  100.551289,
		Location:   `Silpakorn University`,
		DateTime:   time.Now().AddDate(1, 1, 0).Add(27 * time.Hour).Add(18 * time.Minute),
		Duration:   `1:30:00`,
		Price:      17000,
		Instrument: false,
	})
	...
	db.Create(&model.Booking{
		...
		Longitude:  100.551289,
		Location:   `Silpakorn University`,
		DateTime:   time.Now().AddDate(1, 7, 0).Add(47 * time.Hour).Add(58 * time.Minute),
		Duration:   `1:30:00`,
		Price:      17000,
		Instrument: false,
	})
	...
	db.Create(&model.Booking{
		...
		Longitude:  100.551289,
		Location:   `Silpakorn University`,
		DateTime:   time.Now().AddDate(1, 2, 0).Add(10 * time.Hour).Add(30 * time.Minute),
		Duration:   `1:30:00`,
		Price:      10000,
		Instrument: false,
	})
